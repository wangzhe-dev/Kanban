 ...
 * @LastEditTime: 2024-04-11 17:55:21
...
import * as service from "@/api/LargeScreen";
export default {
  data() {
    return {};
  },
  ...
  methods: {
      ...
      */
      switch (type) {
        case "STATUS":
          ...
          if (this.screenType === "zhongdeScreen") {
            this.equipmentList = [...this.equipmentList];
          }
          this.equipmentList = [...this.equipmentList];
          // this.initEquipmentStatusList()
    ...
    setStatusCardList() {
      ...
      console.log(" this.statusCardList", this.statusCardList);
