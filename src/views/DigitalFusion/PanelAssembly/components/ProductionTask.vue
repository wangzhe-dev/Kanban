  ...
  <div class="production-task">
    ...
    <div class="left-section">
      ...
      <div class="overlay-content">
        ...
        <div class="product-label">片体拼接数量</div>
      </div>
    </div>
        ...
        <table class="df-table">
          ...
          <tbody>
            <tr v-for="(item, index) in taskData" :key="index">
              ...
              <td style="color: rgb(255, 153, 0)">{{ item.assemblyQuantity }}</td>
              <td style="color: rgb(255, 217, 0)">{{ item.plannedQuantity }}</td>
              <td style="color: rgb(140, 209, 125)">{{ item.completedQuantity }}</td>
              <td style="color: rgb(55, 217, 240)">{{ item.setQuantity }}</td>
