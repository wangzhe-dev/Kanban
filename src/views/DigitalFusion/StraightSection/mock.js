...
export const processData = [
  ...
  { name: "平直分段产品", started: 0, notStarted: 0, completed: 0 },
];
...
export const stationData = [
  ...
  { name: "平直分段产品工位", started: 0, notStarted: 0, completed: 0 },
];
...
export const processQualityData = [
  { name: "装配工位", started: 12, completed: 9 },
  { name: "自动焊接工位", started: 10, completed: 7 },
  { name: "01-修补工位", started: 14, completed: 11 },
  { name: "顶升运出工位", started: 9, completed: 6 },
];

// 工位统计数据（右侧图表）
export const stationQualityData = [
  { name: "装配工位", started: 1.2, completed: 1.0 },
  { name: "自动焊接工位", started: 0.8, completed: 0.6 },
  { name: "修补工位", started: 1.5, completed: 1.2 },
  { name: "顶升运出工位", started: 0.9, completed: 0.7 },
];
