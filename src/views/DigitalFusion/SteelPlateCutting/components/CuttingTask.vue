        ...
        <table class="df-table df-table-header">
          ...
          <tbody>
            <tr v-for="(item, index) in taskData" :key="index">
              ...
              <td style="color: rgb(255, 153, 0)">{{ item.sectionNumber }}</td>
              <td style="color: rgb(255, 217, 0)">{{ item.category }}</td>
              <td style="color: rgb(55, 217, 240)">{{ item.actualStartTime }}</td>
              <td style="color: rgb(140, 209, 125)">{{ item.actualEndTime }}</td>
              <td>{{ item.issueTime }}</td>
              <td style="color: rgb(55, 217, 240)">{{ item.length }}</td>
              <td style="color: rgb(140, 209, 125)">{{ item.width }}</td>
              <td style="color: rgb(255, 190, 125)">{{ item.thickness }}</td>
              <td>{{ item.weight }}</td>
            </tr>
          </tbody>
        </table>
