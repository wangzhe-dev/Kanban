  ...
  <div class="production-task">
    ...
    <div class="left-section">
      ...
      <div class="overlay-content">
        ...
        <div class="product-label">切割完成数量</div>
      </div>
    </div>
        ...
        <table class="df-table">
          ...
          <tbody>
            <tr v-for="(item, index) in taskData" :key="index">
              <td style="color: rgb(64, 213, 255)">{{ item.orderNo }}</td>
              <td style="color: rgb(163, 224, 67)">{{ item.shipNo }}</td>
              <td style="color: rgb(255, 153, 0)">{{ item.batchNo }}</td>
              <td style="color: rgb(255, 217, 0)">{{ item.segmentNo }}</td>
              <td style="color: rgb(140, 209, 125)">{{ item.actualStart }}</td>
              <td style="color: rgb(55, 217, 240)">{{ item.actualEnd }}</td>
              <td style="color: rgb(163, 224, 67)">{{ item.pushTime }}</td>
              <td style="color: rgb(255, 153, 0)">{{ item.quantity }}</td>
