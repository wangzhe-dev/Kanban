...
-->
<template>
  <div class="container-TProfile">
    <div class="t-profile-screen" ref="appRef">
      <MainLayout activeTab="TProfile" @tab-click="handleTabClick">
        <template #left>
        ...
        <template #right-bottom>
          <Card title="班组" :titleMargin="'20px 0 0 0'" :flex="3" column="right"
            position="bottom" :totalCards="3" :showTimeRange="false"
            :bodyPadding="'40px 20px 20px 20px'">
...
export default {
  ...
  computed: {
    ...
    orderStatisticsData() {
      // 默认使用日维度，与 PanelAssembly 保持一致
      return getOrderStatisticsData("day");
    },
  },
  methods: {
